/* ==========================================================================
   Marginalia · Mock curated booklist (PHASE 0 — placeholder)
   --------------------------------------------------------------------------
   Hand-picked annual highlights shown in the Booklist view's "Year-In-Reading
   Shelf" track. Will be replaced by user-authored selections persisted in
